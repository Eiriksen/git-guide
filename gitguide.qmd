...
A git project is really just a folder of files. Any folder on your computer can be turned into a git project, and git can track any kind of files (with some notable caveats, see XXX).
...
![](images/paste-16.png){width="700"} \## git commands:
